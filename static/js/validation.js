 function inputValidation(inputTxt){
    ...
    if(inputTxt.value != '' ){
        ...
        if(inputTxt.value.length >= 1){
            ...
            textField.textContent = 'your input is less than 1 chracters';
            textField.style.color = "red";
        }
    }else{
...
function fnameValidation(inputTxt){
    ...
    if(inputTxt.value != '' ){
        ...
        if(inputTxt.value.length >= 3){
            ...
            textField.textContent = '**your firstname must Start with a Capital Letter';
            textField.style.color = "red";
        }
    }else{
...
function lnameValidation(inputTxt){
    ...
    if(inputTxt.value != '' ){
        ...
        if(inputTxt.value.length >= 2){
            ...
            textField.textContent = 'your input must start with Capital letter ';
            textField.style.color = "red";
        }
    }else{
        textField.textContent = 'your input is empty';
...
function cpasswordValidation(inputTxt){
    ...
    var regy =  document.getElementById("confirmpassword").value;
